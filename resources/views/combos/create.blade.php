<!-- Agrega esto en tu layout o directamente en create.blade.php -->
...
<div class="container mt-4">
    ...
    <form action="{{ route('combos.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" id="price" step="0.01" class="form-control" required value="{{ old('price') }}">
        </div>

        <div class="mb-3">
            <label for="discount_price" class="form-label">Precio con Descuento (opcional)</label>
            <input type="number" name="discount_price" id="discount_price" step="0.01" class="form-control" value="{{ old('discount_price') }}">
        </div>
