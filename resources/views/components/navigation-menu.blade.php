    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <!-- En la parte del sidebar donde se encuentran los servicios -->
                <!-- En la parte del sidebar donde se encuentran los servicios -->
                ...
                <div class="collapse" id="collapseServicios" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ route('combos.index') }}">Lista de Combos</a> <!-- Agregado para combos -->
                        <a class="nav-link" href="{{ route('cargos.index') }}">Categoría de servicios</a>
                        <a class="nav-link" href="{{ route('promotions.index') }}">Promociones</a> <!-- Agregado para promociones -->
                    </nav>
                </div>
